...
export default function Admin() {
  ...
  const [aiPrompt, setAiPrompt] = useState(""); // Track the AI input box
  ...
  const handleTemplateClick = (templateName) => {
    ...
    setDescription(`This is a pre-built template for ${templateName}. Feel free to modify the questions.`);
    setFields([
      { name: "q1", label: "How likely are you to recommend us?", type: "linear_scale", required: true, scaleMin: 1, scaleMax: 10 },
      { name: "q2", label: "What did you like most about our product?", type: "long_text", required: false },
      { name: "q3", label: "How can we improve?", type: "long_text", required: false }
    ]);
    setView("builder");
    window.scrollTo(0, 0);
  };
  ...
  const handleAIGenerate = () => {
    if (!aiPrompt) {
      alert("Please type something in the AI box first! (e.g., 'popcorn survey')");
      return;
    }
    setEditingId(null);
    setTitle(`AI Generated: ${aiPrompt}`);
    setDescription(`This survey was magically generated by AI based on your prompt: "${aiPrompt}"`);
    setFields([
      { name: "ai1", label: `How often do you think about ${aiPrompt}?`, type: "multiple_choice", required: true, options: ["Daily", "Weekly", "Rarely", "Never"] },
      { name: "ai2", label: `What is your favorite thing about ${aiPrompt}?`, type: "short_text", required: true },
      { name: "ai3", label: "Would you pay a premium for this?", type: "checkbox", required: false, options: ["Yes, absolutely", "Maybe if it was good", "No way"] }
    ]);
    setAiPrompt("");
    setView("builder");
    window.scrollTo(0, 0);
    ...
    <div style={{ display: "flex", height: "100vh", background: colors.bg, color: colors.textPrimary, fontFamily: "'Inter', 'Segoe UI', sans-serif", overflow: "hidden" }}>
      ...
      <div style={{ width: "240px", background: colors.sidebar, borderRight: `1px solid ${colors.border}`, display: "flex", flexDirection: "column", padding: "24px 0" }}>
        ...
        <div style={{ padding: "0 16px", flex: 1 }}>
          ...
          <div style={navItem} onClick={() => handleSidebarClick("Insights")}><span style={{ fontSize: "16px" }}>📈</span> Insights</div>
          ...
          <div style={navItem} onClick={() => handleSidebarClick("Wallet")}><span style={{ fontSize: "16px" }}>👛</span> Wallet</div>
          <div style={navItem} onClick={() => handleSidebarClick("Settings")}><span style={{ fontSize: "16px" }}>⚙️</span> Settings</div>
        </div>
              ...
              <div style={{ flex: 1, padding: "32px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: `1px solid ${colors.border}`, paddingBottom: "16px", marginBottom: "32px" }}>
                  <div style={{ display: "flex", gap: "24px" }}>
                    ...
                    <span onClick={() => handleSidebarClick("Drafts tab")} style={{ fontSize: "14px", fontWeight: "600", color: colors.textMuted, cursor: "pointer" }}>Drafts</span>
                    <span onClick={() => handleSidebarClick("Completed tab")} style={{ fontSize: "14px", fontWeight: "600", color: colors.textMuted, cursor: "pointer" }}>Completed</span>
                  </div>
                ...
                <div style={{ background: colors.purple, borderRadius: "12px", padding: "32px", color: "#000", position: "relative", overflow: "hidden", marginBottom: "32px" }}>
                  ...
                  <div style={{ background: "rgba(255,255,255,0.3)", padding: "6px", borderRadius: "8px", display: "inline-flex", alignItems: "center", width: "400px", backdropFilter: "blur(4px)" }}>
                    <input 
                      ...
                      placeholder="Eg. market research for new brand" 
                      style={{ background: "transparent", border: "none", color: "#000", padding: "8px 12px", width: "100%", outline: "none", fontSize: "13px" }} 
                    />
                    <button onClick={handleAIGenerate} style={{ background: "#000", color: "#fff", border: "none", padding: "8px 20px", borderRadius: "6px", fontSize: "12px", fontWeight: "700", cursor: "pointer" }}>Generate</button>
                  </div>
                  {/* Decorative Circles */}
                  <div style={{ position: "absolute", right: "60px", top: "50%", transform: "translateY(-50%)", width: "120px", height: "120px", border: "1px dashed rgba(0,0,0,0.2)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }} onClick={handleAIGenerate}>
              ...
              <div style={{ width: "320px", background: colors.card, borderLeft: `1px solid ${colors.border}`, padding: "32px", overflowY: "auto" }}>
                ...
                {[
                  ...
                  <div key={i} style={{ background: colors.inputBg, border: `1px solid ${colors.border}`, borderRadius: "12px", padding: "20px", marginBottom: "16px" }}>
                    ...
                    <button onClick={() => handleTemplateClick(tpl.title)} style={{ width: "100%", padding: "10px", background: colors.purple, color: "#000", border: "none", borderRadius: "8px", fontSize: "12px", fontWeight: "700", cursor: "pointer" }}>Use This Template</button>
                  </div>
                ))}
              </div>
            </>
