    ...
    <div style={{ display: "flex", height: "100vh", background: colors.bg, color: colors.textPrimary, fontFamily: "'Inter', 'Segoe UI', sans-serif", overflow: "hidden", position: "relative" }}>
      ...
      <div style={{ width: "240px", background: colors.sidebar, borderRight: `1px solid ${colors.border}`, display: "flex", flexDirection: "column", padding: "24px 0" }}>
        ...
        <div style={{ padding: "0 16px", flex: 1 }}>
          ...
          <div style={{ ...navItem, background: view === "dashboard" ? "rgba(255,255,255,0.05)" : "transparent", color: view === "dashboard" ? "#fff" : colors.textMuted }} onClick={() => clearBuilder()}>
            <span style={{ fontSize: "16px" }}>⊞</span> Dashboard
          </div>
          <div style={{ ...navItem, background: view === "builder" ? "rgba(255,255,255,0.05)" : "transparent", color: view === "builder" ? "#fff" : colors.textMuted }} onClick={() => { clearBuilder(); setView("builder"); }}>
            <span style={{ fontSize: "16px" }}>📝</span> Create Survey
          </div>
        </div>
          ...
          {view === "dashboard" && (
            <div style={{ flex: 1, padding: "32px", maxWidth: "1200px" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: `1px solid ${colors.border}`, paddingBottom: "16px", marginBottom: "32px" }}>
                ...
                <button onClick={() => { clearBuilder(); setView("builder"); }} style={{ background: "transparent", border: `1px solid ${colors.purple}`, color: colors.purple, padding: "8px 16px", borderRadius: "20px", fontSize: "13px", fontWeight: "600", cursor: "pointer", display: "flex", alignItems: "center", gap: "6px" }}>
                  + New Survey
                </button>
              </div>
              ...
              <div style={{ background: colors.card, borderRadius: "12px", border: `1px solid ${colors.border}`, padding: "24px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
                  <h3 style={{ margin: 0, fontSize: "18px", fontWeight: "700" }}>Your Surveys ({entries.length})</h3>
                </div>
                ...
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  ...
                  <tbody>
                    ...
                    {entries.length === 0 && (
                      <tr><td colSpan="4" style={{ padding: "32px 0", textAlign: "center", color: colors.textMuted, fontSize: "13px" }}>No surveys found. Click "New Survey" to assign one!</td></tr>
                    )}
                  </tbody>
                </table>
              </div>
